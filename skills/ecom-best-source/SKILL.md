...
- `SKU不一致`、品牌不匹配、品类不匹配、价格不合适、明确无库存、综合得分低于 60 的候选不能进入最终 CSV；只能进入 rejected / scratch JSON。不要用低价错货凑 Top 5。
...
- 直接写出带 UTF-8 BOM 的最终 CSV，字段包含 Top 5、价格、起批数、库存、店铺、服务分、推荐理由、风险说明和完整 1688 链接。
